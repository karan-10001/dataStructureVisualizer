...
const BubbleSort = () => {
	const [arr, setArr] = useState([
		{ number: 69, color: "#124416" },
		{ number: 56, color: "#124416" },
		{ number: 10, color: "#124416" },
		{ number: 89, color: "#124416" },
		{ number: 8, color: "#124416" },
		{ number: 56, color: "#124416" },
		{ number: 58, color: "#124416" },
		{ number: 23, color: "#124416" },
		{ number: 77, color: "#124416" },
		{ number: 11, color: "#124416" },
		{ number: 1, color: "#124416" },
	]);
		...
		if (arr.length !== 0) {
			for (let round = 0; round < arr.length - 1; round++) {
				for (let element = 0; element < arr.length - 1 - round; element++) {
					...
					arr[element].color = "#124416";
					arr[element + 1].color = "#124416";
				}
			}
